...
class AtletaFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'birth_certificate'=>'required|mimetypes:application/pdf|max:5000',
            ...
            'signed_contract'=>'required|mimetypes:application/pdf|max:5000',
            'responsible_image'=>'required|mimetypes:application/pdf|max:5000',
