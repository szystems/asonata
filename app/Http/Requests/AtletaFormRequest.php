...
class AtletaFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image'=>'image|required|mimes:jpg,jpeg,bmp,png,gif,pdf|max:3000',
            'birth_certificate'=>'required|mimetypes:application/pdf|max:3000',
            ...
            'signed_contract'=>'required|mimetypes:application/pdf|max:3000',
            'responsible_image'=>'required|mimetypes:application/pdf|max:3000',
