...
class AtletaFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'birth_certificate'=>'required|mimetypes:application/pdf|max:10000',
            ...
            'signed_contract'=>'required|mimetypes:application/pdf|max:10000',
            'responsible_image'=>'required|mimetypes:application/pdf|max:10000',
