...
class AtletaUpdateFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'birth_certificate'=>'image|nullable|mimes:jpg,jpeg,bmp,png,gif,pdf|max:5000',
            'vaccination_card'=>'image|nullable|mimes:jpg,jpeg,bmp,png,gif,pdf|max:5000',
            'birth'=>'required|date',
            ...
            'responsible_image'=>'image|nullable|mimes:jpg,jpeg,bmp,png,gif,pdf|max:5000',
