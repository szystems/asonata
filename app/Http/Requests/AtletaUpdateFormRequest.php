...
class AtletaUpdateFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'birth_certificate'=>'mimetypes:application/pdf|max:5000',
            'vaccination_card'=>'mimetypes:application/pdf|max:5000',
            'birth'=>'required|date',
            ...
            'signed_contract'=>'mimetypes:application/pdf|max:5000',
            'responsible_image'=>'mimetypes:application/pdf|max:5000',
