...
class AtletaUpdateFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image'=>'image|nullable|mimes:jpg,jpeg,bmp,png,gif,pdf|max:3000',
            'birth_certificate'=>'mimetypes:application/pdf|max:3000',
            'vaccination_card'=>'mimetypes:application/pdf|max:3000',
            'birth'=>'required|date',
            ...
            'signed_contract'=>'mimetypes:application/pdf|max:3000',
            'responsible_image'=>'mimetypes:application/pdf|max:3000',
