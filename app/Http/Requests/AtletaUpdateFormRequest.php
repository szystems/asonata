...
class AtletaUpdateFormRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'cui_dpi'=>'required|string',
            'name'=>'required|string|max:100',
            'image'=>'image|nullable|mimes:jpg,jpeg,bmp,png,gif,pdf|max:5000',
            'birth_certificate'=>'mimetypes:application/pdf|max:10000',
            'vaccination_card'=>'mimetypes:application/pdf|max:10000',
            'birth'=>'required|date',
            ...
            'signed_contract'=>'mimetypes:application/pdf|max:10000',
            'responsible_image'=>'mimetypes:application/pdf|max:10000',
            'responsible_phone'=>'string|max:20',
