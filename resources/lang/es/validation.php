...
return [
    ...
    'attributes'           => [
        ...
        'role'                     => 'rol',
        'second'                   => 'segundo',
        'selling_price'            => 'precio descuento',
        'sex'                      => 'sexo',
        'short_text'               => 'texto corto',
        'size'                     => 'tamaño',
        'slug'                     => 'nombre en url',
        'small_description'        => 'descripcion pequeña',
        'state'                    => 'municipio',
        'street'                   => 'calle',
        'student'                  => 'estudiante',
        'subject'                  => 'asunto',
        ...
        'username'                 => 'usuario',
        'year'                     => 'año',
        'facility_id'              => 'instalación',
        'start_time'               => 'hora inicial',
        'end_time'                 => 'hora final',
        'quota'                    => 'cupo',
        'vaccination_card'          => 'Cartilla de vacunacion',
        'responsible_dpi'          => 'cui dpi del responsable',
        'responsible_name'         => 'nombre del responsable',
        'responsible_phone'        => 'teléfono del responsable',
        'responsible_email'        => 'correo electrónico del responsable',
        'responsible_address'      => 'dirección del responsable',
        'responsible_image'      => 'Dpi del responsable',
        ...
        'payments_description'     =>'descripcion de pagos',
        'monthly_payment'          =>'pago mensual',
        'badge'                    =>'gafete',
        'birth'                    =>'Fecha de Nacimiento',
        'birth_certificate'        =>'Certificado de Nacimiento',
        'inscription_payment'      =>'Pago de inscripción',
        'doses_number'             =>'Número de dosis',
        'ethnic_group'             =>'Grupo Etnico',
        'education_obtained'       =>'Escolaridad Obtenida',
        'tshirt_size'              =>'Tamaño de Playera',
        'kinship'                  =>'Parentesco',
        'responsible_doses_number' =>'Número de dosis del responsable',
