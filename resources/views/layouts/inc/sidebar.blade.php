        ...
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role_as != "3")
                ...
                @if (Auth::user()->role_as != "0")
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white {{ Request::is('index_noticias','show-noticia/*','add-noticia','edit-noticia/*') ? 'active bg-gradient-primary':''  }}" href="{{ url('index_noticias') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="material-icons opacity-10">newspaper</i>
                            </div>
                            <span class="nav-link-text ms-1">{{ __('Noticias') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
