...
@section('content')
    <div class="page-header text-center" style="background-image: url('{{ asset('fronttemplate/assets/images/page-header-bg.jpg') }}')">
        <div class="container">
            <h1 class="page-title">{{ __('Inscriptions') }}<span>{{ __('New Athlete Information') }}</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ url('new-athlete-inscription') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" name="cui_dpi" onkeypress="return validarentero(event,this.value)" value="{{ $cui_dpi }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input readonly type="text" class="form-control" name="country" value="Guatemala">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="file" name="birth_certificate" class="form-control" value="{{ old('birth_certificate') }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control" name="kinship">
                                            <option value="{{ old('kinship') }}">{{ old('kinship') }}</option>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control" name="responsible_doses_number">
                                            <option value="{{ old('responsible_doses_number') }}">{{ old('responsible_doses_number') }}</option>
                                            <option value="Ninguna">Ninguna</option>
                                            <option value="1ra. Dosis">1ra. Dosis</option>
                                            <option value="2da. Dosis">2da. Dosis</option>
                                            <option value="3ra. Dosis">3ra. Dosis</option>
                                    ...
                                    <div class="col-sm-12">
                                        <label for="">{{ __('Responsible DPI') }} (PDF)</label>
                                        <input type="file" name="responsible_image" class="form-control" value="{{ old('responsible_image') }}" required>
