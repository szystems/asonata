                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">{{ __('Edit Class') }}</h6>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select px-2" aria-label="Default select example" name="category_id">
                                        <option value="{{ $class->category_id }}">{{ $categoryClass->name }}</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select px-2" aria-label="Default select example" name="instructor_id">
                                        <option value="{{ $class->instructor_id }}">{{ $instructorClass->name }}</option>
                                    ...
                                    <label for="">{{ __('Start Date') }} </label>
                                        <div class="input-daterange input-group" >
                                            <div class="input-group input-group-dynamic mb-4">
                                                ...
                                                <input type="text" class="form-control" id="startdate" aria-label="Amount (to the nearest dollar)" name="start_date" value="{{ $start_dateClass }}" >
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <label for="">{{ __('End Date') }} </label>
                                        <div class="input-daterange input-group" >
                                            <div class="input-group input-group-dynamic mb-4">
                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                <input type="text" class="form-control" id="enddate" aria-label="Amount (to the nearest dollar)" name="end_date" value="{{ $end_dateClass }}" >
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <label for="">{{ __('Inscription') }} </label>
                                        <div class="input-daterange input-group" >
                                            <div class="input-group input-group-dynamic mb-4">
                                                ...
                                                <input type="number" step=".01" class="form-control" id="inscription_payment" aria-label="Amount (to the nearest dollar)" name="inscription_payment" value="{{ $class->inscription_payment }}" >
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="">{{ __('Badge') }} </label>
                                        <div class="input-daterange input-group" >
                                            <div class="input-group input-group-dynamic mb-4">
                                                {{ $config->currency_simbol }}
                                                <input type="number" step=".01" class="form-control" id="badge" aria-label="Amount (to the nearest dollar)" name="badge" value="{{ $class->badge }}" >
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="">{{ __('Monthly Payment') }} </label>
                                        <div class="input-daterange input-group" >
                                            <div class="input-group input-group-dynamic mb-4">
                                                {{ $config->currency_simbol }}
                                                <input type="number" step=".01" class="form-control" id="monthly_payment" aria-label="Amount (to the nearest dollar)" name="monthly_payment" value="{{ $class->monthly_payment }}" >
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="mostrar" {{ $class->mostrar == 1 ? 'checked':'' }}>
