...
@section('content')
<form action="{{ url('update-assist/'.$assist->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
                ...
                <div class="card-body p-3 pt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control border px-2" name="notes" rows="3">{{ $assist->notes }}</textarea>
                                            ...
                                            <div class="d-flex px-2 py-1">
                                              <div class="d-flex flex-column justify-content-center">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" name="status_{{ $attendance->id }}" {{ $attendance->status == 1 ? 'checked':'' }}>
                                                </div>
                                              </div>
                                            </div>
                                        </td>
