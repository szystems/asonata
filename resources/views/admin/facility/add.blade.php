        ...
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
            <div class="card">
                ...
                <div class="card-body p-3 pt-2">
                    ...
                    @endif
                    <form action="{{ url('insert-facility') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="">{{ __('Location') }}</label><br>
                                <textarea class="form-control border px-2" name="location" rows="5">{{ old('location') }}</textarea>
