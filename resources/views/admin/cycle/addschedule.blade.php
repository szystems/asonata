            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-center pt-1">
                        ...
                        <h4 class="mb-0">{{ __('Schedules') }}</h4>
                    </div>
                    <hr class="dark horizontal my-0">
                </div>
                <div class="card-body p-3 pt-2">
                    <h4><u>{{ __('Add Schedule') }}</u></h4>
                    @if (count($errors)>0)
                    ...
                    @endif
                    <form action="{{ url('insert-schedule') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="time" class="form-control border px-2 " name="start_time" value="{{ old('start_time') }}" >
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="time" class="form-control border px-2 " name="end_time" value="{{ old('end_time') }}" >
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="quota" value="{{ old('quota') }}" >
                                @if ($errors->has('quota'))
                                    <span class="help-block opacity-7">
                                            <strong>
