                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <a href="{{ url('add-instructor') }}" class="btn btn-success">
                                <i class="material-icons opacity-10">add</i> {{ __('Add Instructor') }}
                            </a>
                                ...
                                <table class="table table-sm align-products-center mb-0 table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">{{ __('Whatsapp') }}</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    @if ($user->image)
                                                    <div>
                                                        <img src="{{ asset('assets/uploads/users/'.$user->image) }}" class="avatar avatar-sm me-3">
                                                    </div>
                                                @endif
                                            ...
                                            <td class="align-middle text-center text-sm"><strong>{{ $user->whatsapp }}</strong></td>
                                            <td class="align-middle text-center text-sm"><strong>
                                                {{ $user->role_as == '0' ? __('User') : ($user->role_as == '1' ? __('Admin') : ($user->role_as == '3' ? __('Instructor') : "")) }}
                                            </strong></td>
                                            <td class="align-middle  text-sm">
                                                <a href="{{ url('show-instructor/'.$user->id) }}" type="button" class="btn btn-info"><i class="material-icons">visibility</i></a>
