        ...
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
            <div class="card">
                ...
                <div class="card-body p-3 pt-2">
                    ...
                    @endif
                    <form action="{{ url('insert-athlete') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                ...
                                <label for="">{{ __('Date of Birth') }} </label>
                                    <div class="input-daterange input-group" >
                                        <div class="input-group input-group-dynamic mb-4">
                                            ...
                                            <input type="text" class="form-control" id="datepickerbirth" aria-label="Amount (to the nearest dollar)" name="birth" value="{{ old('birth') }}" >
                                            @if ($errors->has('birth'))
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="cui_dpi" onkeypress="return validarentero(event,this.value)" value="{{ old('cui_dpi') }}" >
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="1" pattern="\d+" class="form-control border px-2 " name="phone" value="{{ old('phone') }}">
                                @if ($errors->has('phone'))
                                    <span class="help-block opacity-7">
                                            <strong>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="whatsapp" value="{{ old('whatsapp') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="email" value="{{ old('email') }}" >
                                @if ($errors->has('email'))
                                    <span class="help-block opacity-7">
                                            <strong>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="address" value="{{ old('address') }}">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="responsible_name" value="{{ old('responsible_name') }}" >
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="responsible_dpi" value="{{ old('responsible_dpi') }}" >
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="responsible_phone" value="{{ old('responsible_phone') }}" >
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control border px-2 " name="responsible_whatsapp" value="{{ old('responsible_whatsapp') }}" >
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="responsible_email" value="{{ old('responsible_email') }}" >
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <input type="text" class="form-control border px-2 " name="responsible_address" value="{{ old('responsible_address') }}" >
